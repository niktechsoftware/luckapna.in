                ...
                <div id="main-wrapper">
                    <div class="row">
                        <div class="col-md-3 center">
                            <div class="login-box">
                                <a href="<?php echo base_url()?>apanel/index" class="logo-name text-lg text-center">Anandmay Login Panel</a>
                                ...
                                <p class="text-center m-t-xs text-sm">2018 &copy; anandmay.co.in</p>
                            </div>
                        </div>
                    </div><!-- Row -->
                </div><!-- Main Wrapper -->
